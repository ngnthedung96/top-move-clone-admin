...
export default {
  page: {
    title: "Chọn đẩy đối tác hàng loạt",
    meta: [
      {
        name: "description",
  ...
  data() {
    return {
      ...
      items: [
        ...
        {
          text: "Chọn đẩy đối tác hàng loạt",
          active: true,
        },
      ],
      showModal: false,
    ...
    <div class="wrapper wrapper-content">
      <div class="row">
        <div class="col-lg-12 animated fadeInRight">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Chọn đẩy đối tác hàng loạt (Từ trạng thái nhập kho nhận)</h5>
              <form id="formSearch" class="mt-3" role="form">
                ...
                <div class="table-responsive mt-3">
                  <div class="form-group row" data-select2-id="7">
                                        <label class="col-sm-2">Chọn đối tác đẩy đơn </label>
                                        <div class="col-sm-4" data-select2-id="6">
                                            <select name="partner" id="partner" class="form-control select2_jq select2-hidden-accessible" data-select2-id="partner" tabindex="-1" aria-hidden="true">
                                                 <option value="bestinc" data-select2-id="2">BEST EXPRESS</option> <option value="vtpost" data-select2-id="12">VIETTEL POST</option> <option value="ninjavan" data-select2-id="13">NINJAVAN</option> <option value="giaohangtietkiem" data-select2-id="14">GHTK</option> <option value="jtexpress" data-select2-id="15">J&amp;T EXPRESS</option> <option value="giaohangnhanh" data-select2-id="16">GHN</option>                                            </select>
                                            <select name="id_connect_partner" id="id_connect_partner" class="form-control select2_jq select2-hidden-accessible" data-select2-id="id_connect_partner" tabindex="-1" aria-hidden="true">
                                                <option value="3" data-select2-id="4">TKtest - cus351993</option>                                            </select>
                                        </div>
                                    </div>
                                      <div id="dt_orders_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer mt-3">
