    ...
    <div class="wrapper wrapper-content">
      <div class="row">
        <div class="col-lg-12 animated fadeInRight">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Chọn lấy hàng hàng loạt (Từ trạng thái tạo mới)</h5>
              <form id="formSearch" role="form">
                ...
                <div class="table-responsive mt-3">
                                      <div class="form-group row">
                                          <label class="col-sm-2">Shipper lấy hàng </label>
                                          <div class="col-sm-4">
                                              <select id="shipper_id" name="shipper_id" class="form-control select2_jq select2-hidden-accessible" data-select2-id="shipper_id" tabindex="-1" aria-hidden="true">
                                                  <option value="0" disabled selected data-select2-id="2">Chọn tài khoản shippers</option>
                                                                                                      <option value="3172">0387171111 - testSHIP</option> 
                                                                          
                                              </select>
                                          </div>
                                      </div>
                                      <div id="dt_orders_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                        <div class="mt-3" style="float:left"><div class="dt-buttons"> <button class="dt-button btn btn-success btn-xs" tabindex="0" aria-controls="dt_orders" type="button"><span><i class="fa fa-check" aria-hidden="true"></i> Quét chọn</span></button> <button class="dt-button btn btn-danger btn-xs" tabindex="0" aria-controls="dt_orders" type="button"><span><i class="fa fa-list" aria-hidden="true"></i> Quét tất cả</span></button> </div></div>
                                        <div class="mt-3" style="float: right;width: 15%;"><div id="dt_orders_length" class="
                              dataTables_length
                              d-flex
                              flex-row
