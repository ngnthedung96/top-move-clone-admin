...
export default {
  page: {
    title: "Quét kiện hàng có vấn đề",
    meta: [
      {
        name: "description",
    ...
    <div class="wrapper wrapper-content">
      <div class="row">
        <div class="col-lg-12 animated fadeInRight">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title py-2">Quét kiện hàng có vấn đề</h5>
              <!-- <div class="card-content" v-html="render"></div> -->
              <div class="card-content">
                <div class="form-group row">
                  <select class="select_type_reason col-sm-2">
                    <option value="default">Lý do mặc định</option>
                    <option value="option">Lý do khác</option>
                  </select>
                  <div class="col-sm-10">
                    <div class="input-group m-b ui-widget">
                      <select
                        id="reason_of_trouble_select"
                        class="form-control key_up_scaner"
                      >
                        <option
                          value="Shipper đã gọi nhưng khách không nghe máy"
                        >
                          Shipper đã gọi nhưng khách không nghe máy
                        </option>
                        <option
                          value="Shipper đã liên hệ nhưng khách từ chối nhận đơn hàng này"
                        >
                          Shipper đã liên hệ nhưng khách từ chối nhận đơn hàng
                          này
                        </option>
                        <option
                          value="Bill dán trên đơn hàng không đúng với sản phẩm bên trong. Nhờ shop kiểm tra lại"
                        >
                          Bill dán trên đơn hàng không đúng với sản phẩm bên
                          trong. Nhờ shop kiểm tra lại
                        </option>
                        <option
                          value="Khách đang bận và shipper đã hẹn giao lại cho khách"
                        >
                          Khách đang bận và shipper đã hẹn giao lại cho khách
                        </option>
                        <option
                          value="Số điện thoại của khách không đúng, nhờ shop hỗ trợ cập nhật lại số điện thoại đúng giúp shipper"
                        >
                          Số điện thoại của khách không đúng, nhờ shop hỗ trợ
                          cập nhật lại số điện thoại đúng giúp shipper
                        </option>
                        <option
                          value="Khách không nhận vì sản phẩm không giống quảng cáo"
                        >
                          Khách không nhận vì sản phẩm không giống quảng cáo
                        </option>
                        <option
                          value="Tuyến đang quá tải, shipper sẽ cố gắng giao trong thời gian sớm nhất"
                        >
                          Tuyến đang quá tải, shipper sẽ cố gắng giao trong thời
                          gian sớm nhất
                        </option>
                      </select>
                      <input
                        type="text"
                        id="reason_of_trouble"
                        placeholder="Nhập vấn đề của kiện hàng "
                        class="form-control key_up_scaner"
                        style="display: none"
                      />
                    </div>
