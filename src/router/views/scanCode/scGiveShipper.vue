...
export default {
  page: {
    title: "Quét chuyển giao đơn hàng",
    meta: [
      {
        name: "description",
  ...
  data() {
    return {
      ...
      items: [
        ...
        {
          text: "Quét chuyển giao đơn hàng",
          active: true,
        },
      ],
      showModal: false,
    ...
    <div class="wrapper wrapper-content">
      <div class="row">
        <div class="col-lg-12 animated fadeInRight">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title py-2">Quét chuyển giao đơn hàng</h5>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select
                        ...
                        "
                        data-select2-id="shipper_id"
                        tabindex="-1"
                        aria-hidden="true"
                      >
                        <option value="0" data-select2-id="2">
                          Chọn tài khoản shippers
                        </option>
